...
const defaultDescription = 'Unofficial subreddit for the game Among Us by Innersloth.';
...
const defaultPage = canonicalUrl => {
  return canonicalUrl.replace(urlRoot, 'https://ramong.us');
};
...
const TitleAndMetaTags = ({
  ...
  return (
    <Helmet title={title}>
      ...
      <meta property="og:image" content="https://ramong.us/logo-og.png" />
      <meta
