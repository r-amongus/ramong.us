...
const colors = {
  lighter: '#666', // light gray
  dark: '#000', // pitch black
  darker: '#111', // really dark black
  brand: '#2377d0', // blue
  brandLight: '#fff',
  text: '#888', // very dark grey / black substitute
  subtle: '#666', // light grey for text
  subtleOnDark: '#999',
  divider: '#333', // very light grey
  note: '#e5e5e5', // yellow
  error: '#ff6464', // yellow
  black: '#000',
  white: '#fff'
...
const sharedStyles = {
  ...
  markdown: {
    ...
    '& blockquote': {
      ...
      borderLeftColor: hex2rgba('#ffe564', 1),
      borderLeftWidth: 9,
